...
class MoviesFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $shawshank->setImg(base64_encode(file_get_contents('public/images/shawshank.jpg')));
        ...
        $godfather->setImg(base64_encode(file_get_contents('public/images/godfather.jpg')));
        ...
        $darkKnight->setImg(base64_encode(file_get_contents('public/images/darkknight.jpg')));
